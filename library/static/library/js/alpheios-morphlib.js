...
var morphlib = function () {
    function morphlib(documentobj, shortdeflat, shortdefgrc) {
        ...
        this.prefs = new preferences("/static/library/js/preferences.json");
        //document object
        this.doc = documentobj;
        //previous morphology results
        this.morphresults = [];
        //short definitions for greek
        jQuery.getJSON("/static/library/js/grc-lsj-defs.json", function (data) {
            xx.shortdefgreek = data;
        });
        //short definitions for persian
        jQuery.getJSON("/static/library/js/per-stg-defs.json", function (data) {
            xx.shortdefpersian = data;
        });
        //short definitions for arabic
        jQuery.getJSON("/static/library/js/ara-sal-ids.json", function (data) {
